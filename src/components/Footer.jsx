...
export const Footer = ({ data }) => {
	return(
      ...
      <Link to='#home'><div href='#home' className='h-12 w-12 rounded-full bg-gray-500 transition-color hover:bg-indigo-600 transition absolute  flex items-center justify-center cursor-pointer -top-5 animate-bounce'>
