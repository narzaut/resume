...
export const Portafolio = ({ data }) => {
	return(
		<div className='text-gray-800 bg-grey-100 py-10 flex flex-col items-center'>
			...
			<div className='text-shadow container py-10 flex flex-col md:flex-row items-center justify-center'>
