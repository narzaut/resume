		...
		<header id="home" className="relative fadeIn main_section  text-white text-shadow " >
			...
			>
				<div className='px-10 absolute top-1/2  transform  -translate-y-1/2 fadeIn max-w-3xl'>
					<div>
						<div className='transition' href='https://github.com/narzaut?tab=repositories'><i class="animate-wiggle   fab fa-github text-9xl  cursor-pointer hover:text-green-500 transition-colors transition" ></i></div>
